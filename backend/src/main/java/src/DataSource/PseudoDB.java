...
public class PseudoDB implements DataBase {


    private static PseudoDB DB;

    private Double dailyAllowance = 15d;

    private Double carMileageRate = 0.3;

    private List<Receipt> receipts = new ArrayList<>(Arrays.asList(Receipt.createInstance("taxi"), Receipt.createInstance("hotel"), Receipt.createInstance("air ticket"), Receipt.createInstance("train"), Receipt.createInstance("subway")));
